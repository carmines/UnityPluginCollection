...
void PayloadHandler::QueueMediaProfile(MediaEncodingProfile const& mediaProfile)
{
	QueueUnknown(winrt::get_unknown(mediaProfile));
}

void PayloadHandler::QueueStreamSample(MediaStreamSample const& sample)
{
	QueueUnknown(winrt::get_unknown(sample));
}

void PayloadHandler::QueueStreamMetadata(Windows::Media::MediaProperties::MediaPropertySet const& metaData)
{
	QueueUnknown(winrt::get_unknown(metaData));
}

void PayloadHandler::QueueStreamMediaDescription(Windows::Media::MediaProperties::IMediaEncodingProperties const& mediaDescription)
{
